  ...
  return (
    <>
      ...
      <p className="text-[14px] text-foreground/80 leading-relaxed mb-3">
        Select <span className="text-accent font-medium">AI Staffing</span> from the Tools section in the sidebar, then type your query.
      </p>
      ...
      <h2 id="rich-results" className="text-[17px] font-semibold text-foreground mt-10 mb-3 scroll-mt-24">
        Rich Results
      </h2>
      <p className="text-[14px] text-foreground/80 leading-relaxed mb-4">
      ...
      <ul className="space-y-1.5 text-[14px] text-foreground/80 mb-4 ml-4 list-disc list-outside">
        <li><span className="text-accent">Company cards</span> — domain, location, employee count, and a summary</li>
        <li><span className="text-accent">Contact cards</span> — name, title, email, phone when available</li>
        <li><span className="text-accent">Job listings</span> — open positions at discovered companies (collapsible)</li>
      </ul>

      <h2 id="conversation-management" className="text-[17px] font-semibold text-foreground mt-10 mb-3 scroll-mt-24">
