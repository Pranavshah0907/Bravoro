...
export default function PeopleEnrichmentSection() {
  return (
    <>
      ...
      <h2 id="enrichment-results" className="text-[17px] font-semibold text-foreground mt-10 mb-3 scroll-mt-24">
        Enrichment Results
      </h2>
      <p className="text-[14px] text-foreground/80 leading-relaxed mb-4">
      ...
      <ul className="space-y-1.5 text-[14px] text-foreground/80 mb-4 ml-4 list-disc list-outside">
        <li><span className="text-accent">Mobile Phone</span> — personal mobile number</li>
        <li><span className="text-accent">Direct Phone</span> — direct work line</li>
        <li><span className="text-accent">Email</span> — verified business email</li>
        <li><span className="text-accent">LinkedIn</span> — confirmed LinkedIn profile URL</li>
        <li><span className="text-accent">Seniority</span> — current seniority level</li>
      </ul>
      <p className="text-[14px] text-foreground/80 leading-relaxed mb-4">
