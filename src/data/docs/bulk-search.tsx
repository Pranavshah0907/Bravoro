...
export default function BulkSearchSection() {
  return (
    <>
      ...
      <h2 id="input-methods" className="text-[17px] font-semibold text-foreground mt-10 mb-3 scroll-mt-24">
        Input Methods
      </h2>

      <h3 className="text-[15px] font-medium text-foreground mt-6 mb-2">Excel Upload</h3>
      <p className="text-[14px] text-foreground/80 leading-relaxed mb-3">
        Upload a <code className="px-1.5 py-0.5 rounded bg-muted text-accent text-[12px]">.xlsx</code> file
        with the required column headers. Download the template from the upload card to get the
        correct format.
      </p>

      <h3 className="text-[15px] font-medium text-foreground mt-6 mb-2">Google Sheets</h3>
      <p className="text-[14px] text-foreground/80 leading-relaxed mb-3">
        Paste a Google Sheet URL with the same column headers. The sheet must be shared (at least "Anyone with the link" as Viewer).
        See the{" "}
        <Link to="/google-sheets-guide" className="text-accent hover:text-accent underline underline-offset-2">
          Google Sheets Setup Guide
        </Link>{" "}
        for detailed instructions.
      </p>

      <h3 className="text-[15px] font-medium text-foreground mt-6 mb-2">Spreadsheet Grid</h3>
      <p className="text-[14px] text-foreground/80 leading-relaxed mb-3">
      ...
      <h2 id="required-columns" className="text-[17px] font-semibold text-foreground mt-10 mb-3 scroll-mt-24">
        Required Columns
      </h2>
      <DocsTable
      ...
      <h2 id="draft-management" className="text-[17px] font-semibold text-foreground mt-10 mb-3 scroll-mt-24">
        Draft Management
      </h2>
      <p className="text-[14px] text-foreground/80 leading-relaxed mb-4">
